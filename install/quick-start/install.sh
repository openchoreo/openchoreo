...
log_info "    kubectl get secret openchoreo-initial-credentials -n thunder -o jsonpath='{.data.admin-password}' | openssl base64 -d -A; echo"
log_info "  developer@openchoreo.dev (role: developer):"
log_info "    kubectl get secret openchoreo-initial-credentials -n thunder -o jsonpath='{.data.developer-password}' | openssl base64 -d -A; echo"
log_info "  platform-engineer@openchoreo.dev (role: platform-engineer):"
log_info "    kubectl get secret openchoreo-initial-credentials -n thunder -o jsonpath='{.data.pe-password}' | openssl base64 -d -A; echo"
log_info "  sre@openchoreo.dev (role: sre):"
log_info "    kubectl get secret openchoreo-initial-credentials -n thunder -o jsonpath='{.data.sre-password}' | openssl base64 -d -A; echo"
echo ""
log_info "  Thunder Console Admin (login at http://thunder.openchoreo.localhost:8080/console):"
log_info "    kubectl get secret openchoreo-initial-credentials -n thunder -o jsonpath='{.data.thunder-console-admin-password}' | openssl base64 -d -A; echo"
echo ""
