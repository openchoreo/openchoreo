...
#   curl -sL https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/install/k3d/k3d-observability-plane.sh | bash
#
# Or run from a local checkout:
#   install/k3d/k3d-observability-plane.sh

# -- versions (update these on release branches) --
OPENCHOREO_REF="${OPENCHOREO_REF:-release-v1.0}"         # overridable via env
OPENCHOREO_OP_VERSION="${OPENCHOREO_OP_VERSION:-1.0.x}"  # overridable via env; latest 1.0 patch
