...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v0.17/samples/from-source/services/go-docker-greeter/greeting-service.yaml
```
