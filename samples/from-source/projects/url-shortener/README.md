...
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/project.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/resources/postgres.yaml
...
```bash
kubectl apply \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/components/redis.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/components/api-service.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/components/analytics-service.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/components/frontend.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.3/samples/from-source/projects/url-shortener/project.yaml
