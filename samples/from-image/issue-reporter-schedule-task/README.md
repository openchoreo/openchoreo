...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v0.4/samples/from-image/issue-reporter-schedule-task/github-issue-reporter.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v0.4/samples/from-image/issue-reporter-schedule-task/github-issue-reporter.yaml
```
