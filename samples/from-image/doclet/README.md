...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/project.yaml

kubectl apply \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/resources/postgres.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/resources/nats.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/components/service-document.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/components/service-collab.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/components/frontend.yaml

kubectl apply \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/bindings/development/postgres.yaml \
  -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/bindings/development/nats.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-m.1/samples/from-image/doclet/project.yaml
```
