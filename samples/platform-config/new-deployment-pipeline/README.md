...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v0.4/samples/platform-config/new-deployment-pipeline/deployment-pipeline.yaml
```
