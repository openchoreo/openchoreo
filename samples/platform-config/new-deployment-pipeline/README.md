...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2.0-rc.2/samples/platform-config/new-deployment-pipeline/deployment-pipeline.yaml
```
