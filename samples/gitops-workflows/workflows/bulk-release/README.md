...
This directory contains a Workflow for automating bulk releases of components when OpenChoreo with GitOps. This Workflow can release all components across all projects or all components within a specific project in the given GitOps repository.
