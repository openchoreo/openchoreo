...
# Remove project
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0.0-rc.2/samples/gcp-microservices-demo/gcp-microservice-demo-project.yaml
```
