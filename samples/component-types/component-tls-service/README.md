...
```bash
kubectl apply --server-side -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.3.0-rc.1/samples/component-types/component-tls-service/tls-service-component.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.3.0-rc.1/samples/component-types/component-tls-service/tls-service-component.yaml
```
