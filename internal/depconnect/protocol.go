...
// ProtocolVersion is the wire-protocol version of the occ <-> dep-agent tunnel. occ
...
// yamux is layered on. It presents the CP-signed capability, which the dep-agent
...
// maxMessageSize.
var ErrMessageTooLarge = errors.New("depconnect: control message exceeds max size")
...
func WriteMessage(w io.Writer, v any) error {
	...
	if err != nil {
		return fmt.Errorf("depconnect: marshal control message: %w", err)
	}
