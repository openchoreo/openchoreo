...
func (q *Queries) DeleteResourceLabels(ctx context.Context, resourceID int32) error {
...
func (q *Queries) UpsertResource(ctx context.Context, arg UpsertResourceParams) (int32, error) {
