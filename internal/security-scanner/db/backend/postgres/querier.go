...
type Querier interface {
	...
	GetPostureFindingsByResourceID(ctx context.Context, resourceID int32) ([]PostureFinding, error)
	...
	GetResourceLabels(ctx context.Context, resourceID int32) ([]GetResourceLabelsRow, error)
