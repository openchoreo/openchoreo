...
func (h *Handler) CreateSecret(
	...
	audit.SetResource(ctx, &audit.Resource{Type: "secret", ID: string(result.UID), Name: result.Name})
...
func (h *Handler) DeleteSecret(
	...
	audit.SetResource(ctx, &audit.Resource{Type: "secret", Name: request.SecretName})
