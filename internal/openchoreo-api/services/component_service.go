...
func NewComponentService(k8sClient client.Client, projectService *ProjectService, gitProvider GitProvider, webhookBaseURL string, logger *slog.Logger) *ComponentService {
