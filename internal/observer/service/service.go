...
func (s *LoggingService) TriggerRCAAnalysis(ctx context.Context, rcaServiceURL string, alertID string, alertDetails *types.AlertDetails, alertRule *choreoapis.ObservabilityAlertRule) {
