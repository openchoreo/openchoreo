...
type ClientInterface interface {
	...
	GetClusterLogs(ctx context.Context, params *GetClusterLogsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetClusterLogs(ctx context.Context, params *GetClusterLogsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetClusterLogsRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetClusterLogsRequest(server string, params *GetClusterLogsParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1alpha1/cluster-logs")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	GetClusterLogsWithResponse(ctx context.Context, params *GetClusterLogsParams, reqEditors ...RequestEditorFn) (*GetClusterLogsResp, error)
...
type GetClusterLogsResp struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r GetClusterLogsResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetClusterLogsResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetClusterLogsWithResponse request returning *GetClusterLogsResp
func (c *ClientWithResponses) GetClusterLogsWithResponse(ctx context.Context, params *GetClusterLogsParams, reqEditors ...RequestEditorFn) (*GetClusterLogsResp, error) {
	rsp, err := c.GetClusterLogs(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetClusterLogsResp(rsp)
}
...
// ParseGetClusterLogsResp parses an HTTP response from a GetClusterLogsWithResponse call
func ParseGetClusterLogsResp(rsp *http.Response) (*GetClusterLogsResp, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
