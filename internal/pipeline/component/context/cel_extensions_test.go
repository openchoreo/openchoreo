...
func TestDependenciesVolumeMacros(t *testing.T) {
	...
	t.Run("configurations_receiver_unaffected_by_dependencies_extension", func(t *testing.T) {
		...
		mountsResult, err := engine.Render(t.Context(), `${configurations.toContainerVolumeMounts()}`, inputs)
		if err != nil {
		...
		volumesResult, err := engine.Render(t.Context(), `${configurations.toVolumes()}`, inputs)
		if err != nil {
	...
	t.Run("dependencies_and_configurations_volumes_concat_in_single_template", func(t *testing.T) {
		...
		result, err := engine.Render(t.Context(), `${configurations.toVolumes() + dependencies.toVolumes()}`, inputs)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
