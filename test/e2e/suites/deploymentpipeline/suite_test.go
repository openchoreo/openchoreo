...
func TestE2EDeploymentPipeline(t *testing.T) {
	RegisterFailHandler(Fail)
	fmt.Fprintf(GinkgoWriter, "Starting OpenChoreo deployment pipeline e2e suite\n")
	RunSpecs(t, "OpenChoreo E2E DeploymentPipeline Suite")
}
