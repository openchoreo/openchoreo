...
```css
#mermaid-i3wlmmu1i8{font-family:ui-sans-serif,-apple-system,system-ui,Segoe UI,Helvetica;font-size:16px;fill:#333;}@keyframes edge-animation-frame{from{stroke-dashoffset:0;}}@keyframes dash{to{stroke-dashoffset:0;}}#mermaid-i3wlmmu1i8 .edge-animation-slow{stroke-dasharray:9,5!important;stroke-dashoffset:900;animation:dash 50s linear infinite;stroke-linecap:round;}#mermaid-i3wlmmu1i8 .edge-animation-fast{stroke-dasharray:9,5!important;stroke-dashoffset:900;animation:dash 20s linear infinite;stroke-linecap:round;}#mermaid-i3wlmmu1i8 .error-icon{fill:#dddddd;}#mermaid-i3wlmmu1i8 .error-text{fill:#222222;stroke:#222222;}#mermaid-i3wlmmu1i8 .edge-thickness-normal{stroke-width:1px;}#mermaid-i3wlmmu1i8 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-i3wlmmu1i8 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-i3wlmmu1i8 .edge-thickness-invisible{stroke-width:0;fill:none;}#mermaid-i3wlmmu1i8 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-i3wlmmu1i8 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-i3wlmmu1i8 .marker{fill:#999;stroke:#999;}#mermaid-i3wlmmu1i8 .marker.cross{stroke:#999;}#mermaid-i3wlmmu1i8 svg{font-family:ui-sans-serif,-apple-system,system-ui,Segoe UI,Helvetica;font-size:16px;}#mermaid-i3wlmmu1i8 p{margin:0;}#mermaid-i3wlmmu1i8 .entityBox{fill:#ffffff;stroke:#dddddd;}#mermaid-i3wlmmu1i8 .relationshipLabelBox{fill:#dddddd;opacity:0.7;background-color:#dddddd;}#mermaid-i3wlmmu1i8 .relationshipLabelBox rect{opacity:0.5;}#mermaid-i3wlmmu1i8 .labelBkg{background-color:rgba(221, 221, 221, 0.5);}#mermaid-i3wlmmu1i8 .edgeLabel .label{fill:#dddddd;font-size:14px;}#mermaid-i3wlmmu1i8 .label{font-family:ui-sans-serif,-apple-system,system-ui,Segoe UI,Helvetica;color:#333;}#mermaid-i3wlmmu1i8 .edge-pattern-dashed{stroke-dasharray:8,8;}#mermaid-i3wlmmu1i8 .node rect,#mermaid-i3wlmmu1i8 .node circle,#mermaid-i3wlmmu1i8 .node ellipse,#mermaid-i3wlmmu1i8 .node polygon{fill:#ffffff;stroke:#dddddd;stroke-width:1px;}#mermaid-i3wlmmu1i8 .relationshipLine{stroke:#999;stroke-width:1;fill:none;}#mermaid-i3wlmmu1i8 .marker{fill:none!important;stroke:#999!important;stroke-width:1;}#mermaid-i3wlmmu1i8 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}containscontainscontainscontainscreatesdeployed asconfigured byOrganizationProjectComponentDeploymentTrackBuildDeployableArtifactDeploymentBuildConfiguration
```
