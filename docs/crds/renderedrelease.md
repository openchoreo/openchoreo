...
- **Audit Labels**: Tracks which RenderedRelease created each namespace for operational visibility
...
type RenderedReleaseSpec struct {
    // Owner identifies the component that owns this RenderedRelease
...
type Resource struct {
    // ID is a unique identifier for the resource within the RenderedRelease
    ID string `json:"id"`
...
- Adds tracking labels to all resources:
  ...
  - `openchoreo.dev/renderedrelease-resource-id`: Resource ID from spec
  - `openchoreo.dev/renderedrelease-uid`: RenderedRelease UID for ownership tracking
  - `openchoreo.dev/renderedrelease-name`: Name of the RenderedRelease that manages the resource
  - `openchoreo.dev/renderedrelease-namespace`: Namespace of the RenderedRelease that manages the resource
...
- Create namespaces with tracking labels:
  ...
  - `openchoreo.dev/renderedrelease-name`: Name of the creating RenderedRelease
  - `openchoreo.dev/renderedrelease-namespace`: Namespace of the creating RenderedRelease
  - `openchoreo.dev/renderedrelease-uid`: UID of the creating RenderedRelease
...
### Controller Location
- **Main Controller**: [`internal/controller/renderedrelease/controller.go`](../../internal/controller/release/controller.go)
- **Finalization**: [`internal/controller/renderedrelease/controller_finalize.go`](../../internal/controller/release/controller_finalize.go)
- **Status Tracking**: [`internal/controller/renderedrelease/controller_status.go`](../../internal/controller/release/controller_status.go)
- **CRD Definition**: [`api/v1alpha1/renderedrelease_types.go`](../../api/v1alpha1/release_types.go)
...
- **Resource ID Labels**: `openchoreo.dev/renderedrelease-resource-id`
- **RenderedRelease UID Labels**: `openchoreo.dev/renderedrelease-uid`
- **RenderedRelease Name Labels**: `openchoreo.dev/renderedrelease-name`
- **RenderedRelease Namespace Labels**: `openchoreo.dev/renderedrelease-namespace`
