...
// BuildPlaneSpec defines the desired state of a BuildPlane.
type BuildPlaneSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Registries specifies the list of container registries to which built images will be pushed.
	// Each entry may include authentication credentials if required.
...
func (d *BuildPlane) GetConditions() []metav1.Condition {
	return d.Status.Conditions
}

func (d *BuildPlane) SetConditions(conditions []metav1.Condition) {
