...
interface ContainerSectionProps {
    ...
    onContainerChange: (containerName: string, field: keyof Container, value: any) => void;
    onEnvVarChange: (containerName: string, envIndex: number, field: keyof EnvVar, value: string) => void;
    onAddContainer: () => void;
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <TextField
                                            ...
                                            onChange={(e) => onArrayFieldChange(containerName, 'command', e.target.value)}
                                            fullWidth
                                            variant="outlined"
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <TextField
                                            ...
                                            onChange={(e) => onArrayFieldChange(containerName, 'args', e.target.value)}
                                            fullWidth
                                            variant="outlined"
                                            ...
                                            <Grid container spacing={2} alignItems="center">
                                                <Grid item xs={5}>
                                                    <TextField
                                                        label="Name"
                                                        value={envVar.key || ''}
                                                        onChange={(e) => onEnvVarChange(containerName, index, 'key', e.target.value)}
                                                        fullWidth
                                                        variant="outlined"
                                                        size="small"
                                                    ...
                                                    envVar.valueFrom ? (
                                                        ...
                                                        <Grid item xs={5}>
                                                            <TextField
                                                                ...
                                                                label="Value"
                                                                value={envVar.value || ''}
                                                                onChange={(e) => onEnvVarChange(containerName, index, 'value', e.target.value)}
                                                                fullWidth
                                                                variant="outlined"
                                                                size="small"
                                                            />
