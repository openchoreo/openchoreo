...
func main() {
	...
	openapiHandler := openapihandlers.New(services, authzService, projectService, componentService, componentTypeService, logger.With("component", "openapi-handlers"), &cfg)
