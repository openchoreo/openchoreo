...
# Build and push script for Backstage OpenChoreo image (skips TypeScript strict checking)
...
echo "Skipping TypeScript compilation due to unused import warnings..."
echo "Building backend bundle directly..."
yarn build:backend
build_result=$?
