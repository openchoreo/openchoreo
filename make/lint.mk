...
WORKFLOW_TEMPLATE_FILES := \
	$(WORKFLOW_TEMPLATE_DIR)/generate-workload-build-step.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/paketo-buildpack-build-step.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/gcp-buildpack-build-step.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/ballerina-buildpack-build-step.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/docker-build-step.yaml
...
workflow-templates-gen: ## Generate samples/getting-started/workflow-templates.yaml from individual files
	...
	printf '# paketo-buildpack-build-step, gcp-buildpack-build-step,\n'; \
	printf '# ballerina-buildpack-build-step) and the generate-workload-build-step\n'; \
